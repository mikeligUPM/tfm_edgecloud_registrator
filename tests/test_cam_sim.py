...
if __name__ == "__main__":
    test_dir = "C:\\master_iot\\0_MIOT_GDEM\\final_code\\" # dir where the datasets are located
    base_directory = test_dir + ds_selection_prompt() # testing only
    print(f"Selected dataset dir: {base_directory}")
    client = None
    main(client, base_directory, send_freq=5)
